...
edge (the opposite of PoseAssess's y) and its X half-span is 21 cm (integer division of 43/2);
its per-sensor ``Kg`` values are 4x the load per sensor. Conversion to PoseAssess:
